  ...
  return (
    <div className="min-h-screen bg-discord-darker flex items-center justify-center p-4">
      <div className="bg-discord-gray rounded-lg p-8 w-full max-w-md shadow-xl">
        ...
        <p className="text-discord-text-muted text-center mb-6 text-sm">We're so excited to see you again!</p>
        ...
        <p className="text-discord-text-muted text-sm mt-4">
          Need an account?{' '}
          <Link to="/register" className="text-discord-accent hover:underline">Register</Link>
        </p>
      </div>
    </div>
  );
