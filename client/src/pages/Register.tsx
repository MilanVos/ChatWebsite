...
const Register = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
      <div className="nexus-orb w-96 h-96 bg-orange-600 -top-24 -right-24" style={{ animationDelay: '2s' }} />
      <div className="nexus-orb w-80 h-80 bg-red-700 -bottom-16 -left-16" style={{ animationDelay: '6s' }} />
      <div className="nexus-orb w-72 h-72 bg-orange-500 top-1/3 left-1/4" style={{ animationDelay: '10s' }} />
      ...
      <div className="relative z-10 w-full max-w-md">
        <div className="nexus-glass-panel rounded-2xl p-8 shadow-2xl">
          <div className="text-center mb-8">
            ...
            <p className="text-sm" style={{ color: 'rgba(240,226,222,0.55)' }}>Join Nexus and start chatting</p>
          </div>
          ...
          <p className="text-center mt-6 text-sm" style={{ color: 'rgba(240,226,222,0.45)' }}>
            ...
            <Link to="/login" className="font-semibold" style={{ color: '#ff8c42' }}>
              Sign in
            </Link>
          </p>
        </div>
